    ...
    <section>
        <div class="grey-border">
            <ul class="logo-header">
                <li class="logo">
                    <svg fill="var(--bg-primary)" viewBox="0 -336 1557 1557" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cards">
                <div v-for="(quests, index) in quests" :key="index" class="card">
                    <svg class="card-icon" fill="var(--bg-primary)" viewBox="0 -336 1557 1557" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <title>Asset 1</title>
                    ...
                    <div class="card-text"> {{ quests.text }}</div>
                </div>
            </div>
