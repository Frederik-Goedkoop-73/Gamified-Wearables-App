...
<template>
    <main>
        <section>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to KUL Health Monitor.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to KUL Health Monitor, accessible from <a
                            href="https://kul-health-monitor.netlify.app/" rel="external nofollow noopener"
                            target="_blank">https://kul-health-monitor.netlify.app/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: Frederik.Goedkoop@student.uantwerpen.be</p>
                </li>
                <li>
                    <p>By phone number: +32 4 74 54 76 25</p>
                </li>
            </ul>

            <hr>

            <h1 class="to-fix">Privacy Policy</h1>
            <p><strong>Last Updated:</strong> [Insert Date]</p>

            <h2>1. Introduction</h2>
            <p>
                Welcome to [Your Website Name] (the "Website"). This Privacy Policy explains how we collect, use,
            ...
            <p>
                When you participate in our fitness study, we may collect the following personal information:
            </p>
            <ul>
                <li><strong>Demographic Information:</strong> Age, gender, and other demographic details provided in the
                    initial survey.</li>
                <li><strong>Fitness History:</strong> Information about your exercise habits, fitness level, and use of
                    fitness trackers.</li>
                <li><strong>Health Goals:</strong> Your personal health goals and challenges as provided in the initial
                    survey.</li>
            </ul>

            <h3>2.2. Fitbit Data</h3>
            <p>
                If you choose to connect your Fitbit account to our Website, we may collect data from your Fitbit
                tracker, including:
            </p>
            <ul>
                <li>Step count</li>
                <li>Activity levels</li>
                <li>Other fitness-related data</li>
            </ul>
            <p>
                This data is collected only with your explicit consent and is used solely for the purposes of the study.
            </p>

            <h3>2.3. Survey Data</h3>
            <p>
                We collect responses from the initial survey, weekly check-ins, and final survey to monitor your
                progress and gather feedback on the study.
            </p>
            ...
            <ul>
                <li><strong>With Your Consent:</strong> We may share your information with third parties if you give us
                    explicit consent to do so.</li>
                <li><strong>For Legal Reasons:</strong> We may disclose your information if required by law or in
                    response to valid legal requests, such as subpoenas or court orders.</li>
                <li><strong>Service Providers:</strong> We may share your information with third-party service providers
                    who assist us in operating the Website and conducting the study. These providers are contractually
                    obligated to protect your information and use it only for the purposes we specify.</li>
            </ul>

            <h2>5. Data Security</h2>
            <p>
                We take the security of your information seriously and implement appropriate technical and
                organizational measures to protect it from unauthorized access, disclosure, or misuse. These measures
            ...
            <p>
                ...
                this Privacy Policy or as required by law. Once the retention period expires, we will delete or
                anonymize your data.
            </p>
            ...
            <ul>
                ...
                <li><strong>Deletion:</strong> You can request that we delete your personal information, subject to
                    certain legal obligations.</li>
                <li><strong>Withdraw Consent:</strong> If you have provided consent for us to process your data, you can
                    withdraw that consent at any time.</li>
            </ul>
            <p>
            ...
            <p>
                The Website may contain links to third-party websites. We are not responsible for the privacy practices
                or content of these websites. We encourage you to review the privacy policies of any third-party sites
                you visit.
            </p>
            ...
            <p>
                ...
                posting the updated policy on the Website. Your continued use of the Website after the changes become
